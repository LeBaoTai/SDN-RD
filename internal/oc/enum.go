...
func (E_OpenconfigMplsLdp_Neighbor_SessionState) ΛMap() map[string]map[int64]ygot.EnumDefinition {
	return ΛEnum
}
...
func (E_OpenconfigOspf_LsaGeneration_TimerType) ΛMap() map[string]map[int64]ygot.EnumDefinition {
	return ΛEnum
}
...
func (E_OpenconfigPolicyForwarding_FORWARDING_ACTION) ΛMap() map[string]map[int64]ygot.EnumDefinition {
	return ΛEnum
}
...
func (E_OpenconfigQosTypes_QOS_SCHEDULER_TYPE) ΛMap() map[string]map[int64]ygot.EnumDefinition {
	return ΛEnum
}
...
func (E_OpenconfigQosTypes_QueueBehavior) ΛMap() map[string]map[int64]ygot.EnumDefinition {
	return ΛEnum
}
...
func (E_OpenconfigQos_SHARED_BUFFER_LIMIT_TYPE) ΛMap() map[string]map[int64]ygot.EnumDefinition {
	return ΛEnum
}
...
func (E_WeightedEcmp_LoadBalancingWeight_Enum) ΛMap() map[string]map[int64]ygot.EnumDefinition {
	return ΛEnum
}
